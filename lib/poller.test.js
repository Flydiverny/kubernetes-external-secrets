...
describe('Poller', () => {
  ...
  describe('_checkExternalSecretStatus', () => {
    let poller
    let clock
    let fakeStatus
    let fakeDate
    ...
    describe('last sync', () => {
      it('no last sync', async () => {
        ...
        await poller._checkExternalSecretStatus()
  ...
  describe('start', () => {
    ...
    beforeEach(() => {
      poller = pollerFactory()
      poller._checkExternalSecretStatus = sinon.stub()
    })
    ...
    it('starts poller', async () => {
      ...
      expect(poller._checkExternalSecretStatus.called).to.equal(true)
    })
  })
